...
//     .filter((room) => {
//       const matchesType = selectedRoomTypes.length === 0 || selectedRoomTypes.includes(room.roomType);
        ...
        <div>
          ...
          {filteredRooms.length === 0 ? (
            <div className="mt-10 text-gray-500">
              <p>
                {cityQuery
                  ? `No rooms found for "${cityQuery}".`
                  : 'No rooms match your filters.'}
              </p>
              {cityQuery && (
                <button
                  onClick={() => navigate('/rooms')}
                  className="mt-4 inline-block px-4 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition"
                >
                  Back to All Rooms
                </button>
              )}
