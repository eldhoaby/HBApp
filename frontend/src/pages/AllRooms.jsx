...
//       </div>
//       <div className='flex items-center gap-l text-gray-500 mt-2
//       text-sm'>
...
//       {/* room amenities */}
//       <div className='flex flex-wrap items-centre mt-3 mb-6 gap-4'>
...
//       {/* Filters */}
//       <div className="bg-white w-80 border border-gray-300 text-gray-600 mb-8 lg:mb-0 mt-0 lg:mt-16">
          ...
          filteredRooms.map((room) => (
            <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
              ...
              <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                <div className='flex items-center'>
                  <StarRating />
                  <p className='ml-2'>{room.reviews?.length || 200}+ reviews</p>
                </div>
