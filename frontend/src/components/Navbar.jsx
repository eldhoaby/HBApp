...
//             <div
//               title="User"
//               className="w-8 h-8 flex items-center justify-center bg-black text-white rounded-full cursor-pointer text-sm font-semibold"
//               onClick={() => setShowUserDropdown(!showUserDropdown)}
//             >
//               {firstLetter}
//             </div>
...
//         {role === "user" && (
//           <>
//             <div className="text-2xl bg-black text-white w-10 h-10 flex items-center justify-center rounded-full">
//               {firstLetter}
//             </div>
//             <Link
//               to="/my-bookings"
