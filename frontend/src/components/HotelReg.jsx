            ...
            <div className='relative flex flex-col items-center md:1/2 p-8 md:p-10'> 
                ...
                <div className='w-full mt-4'>
                    <label htmlFor="name" className="font-medium text-gray-500">
                     ...
                     <input id='name' type="text" placeholder="Type Here" className="border
                 ...
                 <div className='w-full mt-4'>
                    <label htmlFor="contact" className="font-medium text-gray-500">
                     ...
                     <input id='contact' type="text" placeholder="Type Here" className="border
                     border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                     font-light" required/>
                </div>
                  {/* Address */}
                 <div className='w-full mt-4'>
                    <label htmlFor="contact" className="font-medium text-gray-500">
                     ...
                     <input id='address' type="text" placeholder="Type Here" className="border
                     border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500
                     font-light" required/>
                </div>
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    ...
                    <select id="city" className='className="border border-gray-200
